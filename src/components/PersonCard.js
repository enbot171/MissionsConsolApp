  ...
  return (
    ...
    >
      ...
      {onSelect ? (
        ...
        <button
          onClick={(e) => { e.stopPropagation(); onSchedule(person); }}
          className="w-8 h-8 rounded-xl bg-blue-50 text-blue-500 flex items-center justify-center shrink-0 hover:bg-blue-100 transition-colors"
